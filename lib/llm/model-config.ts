...
export const DEBATER_MODELS = [
  ...
  },
  {
    ...
    tier: 'frontier',
    reasoning: 'excellent',
    description: 'Latest Grok with fast reasoning and tool calling',
  },
  {
    id: 'x-ai/grok-4.20',
    name: 'Grok 4.20',
    ...
    tier: 'frontier',
    reasoning: 'excellent',
    description: 'Cost-efficient Grok with large context window',
  },
  {
  ...
  },
  {
    ...
    tier: 'advanced',
    reasoning: 'strong',
    description: 'Fast reasoning with large context',
  },
  {
    id: 'qwen/qwen3-max',
    name: 'Qwen 3 Max',
