/**
 * Simple test runner for rating engine tests
 * Run with: tsx lib/rating/__tests__/run-tests.ts
 */
...
async function runTests() {
  console.log('🧪 Running Rating Engine Tests\n')

  // Import test files
  await import('./glicko2.test')
